...
| ARC-PROC-010 | Executable paths and compatibility tools preserve launch semantics | PROC-010, PROC-022, COMPAT-001..030 | Specified |
...
| ARC-COMP-001 | Required tools and Windows/architecture matrix pass | COMPAT-001..030 | Specified |
